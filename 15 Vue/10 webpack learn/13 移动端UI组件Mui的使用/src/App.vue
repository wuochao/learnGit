...
<template>
	<div>
		...
		<!-- 使用mint-ui中的button组件 -->
		<mt-button @click="tip" type="danger" size="normal">danger</mt-button>
		...
		<!-- 缩略图居左的图文列表 -->
			<ul class="mui-table-view">
				<li class="mui-table-view-cell mui-media">
					<a href="javascript:;">
						<img class="mui-media-object mui-pull-left" src="../statics/imgs/shuijiao.jpg">
...
<ul class="mui-table-view">
		<li class="mui-table-view-cell mui-media">
			<a href="javascript:;">
				<img class="mui-media-object mui-pull-left" src="http://www.webhm.top:8080/upload/201504/16/201504161149414479.jpg">
				<div class="mui-media-body">
					幸福
					<p class='mui-ellipsis'>能和心爱的人一起睡觉，是件幸福的事情；可是，打呼噜怎么办？</p>
				</div>
