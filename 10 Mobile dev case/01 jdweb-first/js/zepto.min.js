...
!function (t, e) {
    ...
    var e = function () {
        ...
        function R(t) {
            return F(t) && !$(t) && Object.getPrototypeOf(t) == Object.prototype
        }
        ...
        function Y(t, i, r) {
            for (n in i)r && (R(i[n]) || D(i[n])) ? (R(i[n]) && !R(t[n]) && (t[n] = {}), D(i[n]) && !D(t[n]) && (t[n] = []), Y(t[n], i[n], r)) : i[n] !== e && (t[n] = i[n])
        }
        ...
        var e, n, i, r, N, P, o = [], s = o.concat, a = o.filter, u = o.slice, f = t.document, c = {}, l = {}, h = {
            "column-count": 1,
            columns: 1,
            "font-weight": 1,
            "line-height": 1,
            ...
            "z-index": 1,
            zoom: 1
        }, p = /^\s*<(\w+|!)[^>]*>/, d = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, m = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, g = /^(?:body|html)$/i, v = /([A-Z])/g, y = ["val", "css", "html", "text", "data", "width", "height", "offset"], x = ["after", "prepend", "before", "append"], b = f.createElement("table"), E = f.createElement("tr"), w = {
        ...
        return C.matches = function (t, e) {
            ...
            var o, s, a;
            return d.test(t) && (o = i(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in w || (n = "*"), a = w[n], a.innerHTML = "" + t, o = i.each(u.call(a.childNodes), function () {
                a.removeChild(this)
            ...
            if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && p.test(t))r = C.fragment(t, RegExp.$1, n), t = null; else {
                ...
                if (C.isZ(t))return t;
                if (D(t))r = q(t); else if (F(t))r = [t], t = null; else if (p.test(t))r = C.fragment(t.trim(), RegExp.$1, n), t = null; else {
                    if (n !== e)return i(n).find(t);
                    r = C.qsa(f, t)
                }
            }
            ...
            return !1
        }, i.type = L, i.isFunction = A, i.isWindow = $, i.isArray = D, i.isPlainObject = R, i.isEmptyObject = function (t) {
            var e;
            for (e in t)return !1;
            return !0
            ...
            closest: function (t, e) {
                ...
                return this.each(function (i, o) {
                    for (; o && !(r ? r.indexOf(o) >= 0 : C.matches(o, t));)o = o !== e && !k(o) && o.parentNode;
            ...
            attr: function (t, i) {
                ...
                return "string" != typeof t || 1 in arguments ? this.each(function (e) {
                    if (1 === this.nodeType)if (F(t))for (n in t)W(this, n, t[n]); else W(this, t, J(this, i, e, this.getAttribute(t)))
            ...
            offset: function (e) {
                if (e)return this.each(function (t) {
                    var n = i(this), r = J(this, e, t, n.offset()), o = n.offsetParent().offset(), s = {
                        top: r.top - o.top,
                        left: r.left - o.left
                    };
            ...
            css: function (t, e) {
                ...
                var a = "";
                if ("string" == L(t))e || 0 === e ? a = _(t) + ":" + H(t, e) : this.each(function () {
                    this.style.removeProperty(_(t))
                }); else for (n in t)t[n] || 0 === t[n] ? a += _(n) + ":" + H(n, t[n]) + ";" : this.each(function () {
            ...
            position: function () {
                if (this.length) {
                    var t = this[0], e = this.offsetParent(), n = this.offset(), r = g.test(e[0].nodeName) ? {
                        top: 0,
                        left: 0
                    } : e.offset();
            ...
            i.fn[t] = function (r) {
                var o, s = this[0];
                return r === e ? $(s) ? s["inner" + n] : k(s) ? s.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function (e) {
    ...
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
        ...
        e.fn.delegate = function (t, e, n) {
            ...
            return t && !s(t) ? (e.each(t, function (t, e) {
                h.on(t, n, a, e, f)
            }), h) : (s(n) || o(u) || u === !1 || (u = a, a = n, n = i), (u === i || a === !1) && (u = a, a = i), u === !1 && (u = E), h.each(function (i, o) {
                f && (c = function (t) {
            ...
            return t && !s(t) ? (e.each(t, function (t, e) {
                a.off(t, n, e)
            }), a) : (s(n) || o(r) || r === !1 || (r = n, n = i), r === !1 && (r = E), a.each(function () {
                x(this, t, r, n)
            }))
        ...
        var r, o, n = +new Date, i = t.document, s = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, a = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, f = "application/json", c = "text/html", l = /^\s*$/, h = i.createElement("a");
        h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (r, o) {
            if (!("type"in r))return e.ajax(r);
            var c, p, s = r.jsonpCallback, a = (e.isFunction(s) ? s() : s) || "Zepto" + n++, u = i.createElement("script"), f = t[a], l = function (t) {
                e(u).triggerHandler("error", t || "abort")
            }, h = {abort: l};
            return o && o.promise(h), e(u).on("load error", function (n, i) {
                clearTimeout(p), e(u).off().remove(), "error" != n.type && c ? y(c[0], h, r, o) : x(null, i || "error", h, r, o), t[a] = f, c && e.isFunction(f) && f(c[0]), f = c = void 0
            ...
            return s.timeout > 0 && (O = setTimeout(function () {
                N.onreadystatechange = w, N.abort(), x(null, "timeout", N, s, a)
        ...
        o.style.transform === e && t.each(r, function (t, r) {
            ...
            if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n)b[h] = n, b[p] = i + "s", b[m] = y + "s", b[d] = r || "linear", j = t.fx.animationEnd; else {
                E = [];
                for (x in n)s.test(x) ? w += x + "(" + n[x] + ") " : (b[x] = n[x], E.push(v(x)));
                w && (b[a] = w, E.push(a)), i > 0 && "object" == typeof n && (b[u] = E.join(", "), b[f] = i + "s", b[l] = y + "s", b[c] = r || "linear")
            }
            return S = function (e) {
        ...
        var i, r, o, s, u, n = {}, a = 750;
        e(document).ready(function () {
            var m, g, x, b, v = 0, y = 0;
            "MSGesture"in t && (u = new MSGesture, u.target = document.body), e(document).bind("MSGestureEnd", function (t) {
                var e = t.velocityX > 1 ? "Right" : t.velocityX < -1 ? "Left" : t.velocityY > 1 ? "Down" : t.velocityY < -1 ? "Up" : null;
                e && (n.el.trigger("swipe"), n.el.trigger("swipe" + e))
            }).on("touchstart MSPointerDown pointerdown", function (t) {
                (!(b = d(t, "down")) || p(t)) && (x = b ? t : t.touches[0], t.touches && 1 === t.touches.length && n.x2 && (n.x2 = void 0, n.y2 = void 0), m = Date.now(), g = m - (n.last || m), n.el = e("tagName"in x.target ? x.target : x.target.parentNode), i && clearTimeout(i), n.x1 = x.pageX, n.y1 = x.pageY, g > 0 && 250 >= g && (n.isDoubleTap = !0), n.last = m, s = setTimeout(c, a), u && b && u.addPointer(t.pointerId))
            }).on("touchmove MSPointerMove pointermove", function (t) {
                (!(b = d(t, "move")) || p(t)) && (x = b ? t : t.touches[0], l(), n.x2 = x.pageX, n.y2 = x.pageY, v += Math.abs(n.x1 - n.x2), y += Math.abs(n.y1 - n.y2))
            }).on("touchend MSPointerUp pointerup", function (t) {
                (!(b = d(t, "up")) || p(t)) && (l(), n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30 ? o = setTimeout(function () {
                    n.el && (n.el.trigger("swipe"), n.el.trigger("swipe" + f(n.x1, n.x2, n.y1, n.y2))), n = {}
