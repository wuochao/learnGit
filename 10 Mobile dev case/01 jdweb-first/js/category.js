...
window.onload = function(){
    ...
    var leftHeight = cleft.offsetHeight;
    //获取滑动列表list元素、滑动列表的高度
    ...
    //设置在静止状态下，最大和最小top值
    var maxTop = 0;
    var minTop = leftHeight - ulListHeight;
    //设置在滑动时，最大和最小top值
    var bounceMaxTop = maxTop + 100;
    var bounceMinTop = minTop - 100;
    //console.log(bounceMaxTop + "" + bounceMinTop); //测试bounceMaxTop和bounceMinTop是否设置成功
    ...
    ulList.addEventListener('touchmove', function(e){
        ...
        //判断滑动的距离distanceY是否超过滑动时的最大值，是否小于滑动时的最小值
